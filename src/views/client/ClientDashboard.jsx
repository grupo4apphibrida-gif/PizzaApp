...
const ClientDashboard = () => {
  ...
  return (
    <div className="client-dashboard">
      ...
      {/* Modal de personalización de producto - Mejorado */}
      <AnimatePresence>
          ...
          >
            ...
            >
              <div className="payment-header">
                ...
                <button className="payment-close" onClick={() => setShowModalPago(false)}>
                  <X size={20} />
                </button>
              </div>
              ...
              <div className="payment-body">
                <div className="delivery-options">
                  ...
                  <div className="delivery-grid">
                    ...
                    <div 
                      className={`delivery-option ${tipoEntrega === "envio" ? 'active' : ''}`}
                ...
                <div className="order-summary">
                  ...
                  <div className="summary-row total">
                    <span>Total</span>
                    <strong>C$ {totalConEnvio.toFixed(2)}</strong>
                  </div>
                </div>
              </div>

              <div className="payment-footer">
                <button className="btn-cancel" onClick={() => setShowModalPago(false)}>
                  Cancelar
                </button>
                <button 
                  className="btn-confirm"
                  onClick={procesarPedido}
                  disabled={procesando || (tipoEntrega === "envio" && !direccionEnvio)}
                >
                  {procesando ? (
                    <>Procesando...</>
                  ) : (
                    <>Confirmar Pedido - C$ {totalConEnvio.toFixed(2)}</>
                  )}
                </button>
              </div>
            </motion.div>
